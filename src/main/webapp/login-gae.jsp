    ...
    <body>
        ...
        <div id="main">
            <c:if test="${X}">
                ...
                <p class="register_info">Kliknij <a href="<%= userCredentials.getGoogleAccountLogout()%>">ten link aby wylogować</a> się z <b>konta Google</b>.</p>
                <a href="/app/" class="logoutButton">Uruchom</a>
            </c:if>
            <c:if test="${!X}">
